...
public class MilesReward extends Reward {
    ...
    public MilesReward(Long id, String transactionId, Card card, String merchant, Integer mcc, Currencies currency, Double amount, Date transactionDate, Double rewardAmount, Double rewardBonusAmount, Double balance, String remarks) {
