...
public class RewardSeeder {
    ...
    public void insertTestData() throws ParseException {
        ...
        Card customer02_card03 = cardRepository.findByCardId("card03").get();
         ...
         MilesReward milesReward01_testCustomer01_card01 =  new MilesReward(1L,"trans01", customer01_card01, "merchant01", 11111, Currencies.SGD, 10.0,
                 new Date(DateHelper.dateFormat().parse("01/03/2023").getTime()),14.0, 0.0, 14.0,  "Base 1.4 Miles/SGD");

         MilesReward milesReward02_testCustomer02_card03 = new MilesReward(2L,"trans02", customer02_card03, "merchant02", 22222, Currencies.SGD, 10.0,
