...
public class CashbackReward extends Reward {
    ...
    public CashbackReward(String tenant, Long id, String transactionId, Card card, String merchant, Integer mcc, Currencies currency, Double amount, Date transactionDate, Double rewardAmount, Double balance, String remarks, CashbackReward previousCashbackTransaction) {
    ...
    public CashbackReward(AddRewardDto addRewardDto, CardRepository cardRepository, CashbackRewardRepository cashbackRewardRepository) {
        ...
        this.setCard(card);
        this.setPreviousTransaction(previousCashbackReward);
    }
